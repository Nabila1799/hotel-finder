...
<center><div class="w3-content w3-section" style="max-width:800px">
  <img class="mySlides w3-animate-top" src="hotel2.jpg" style="width:100%">
  <img class="mySlides w3-animate-bottom" src="hotel3.jpg" style="width:100%">
  <img class="mySlides w3-animate-top" src="hotel6.jpg" style="width:100%">
  <img class="mySlides w3-animate-bottom" src="hotel7.jpg" style="width:100%">
   <img class="mySlides w3-animate-bottom" src="hotel8.jpg" style="width:100%">
</div></center>
